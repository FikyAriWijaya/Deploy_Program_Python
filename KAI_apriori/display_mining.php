...
//        ?>
    ...
    <strong style="color: #c0c0c0; font-size: 23px; margin-bottom: 15px; text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.10);">Rule Asosiasi yang terbentuk :</strong>
    <table class='table table-bordered table-striped  table-hover'>
        <tr>
            <th>No</th>
            <th>X => Y</th>
...
//            $maka = implode(" Dan ", $kom2);
            ...
            echo "<td>" . ($val['korelasi_rule']) . "</td>"; // Menampilkan keterangan pada tabel
            echo "</tr>";
            $no++;
        }
        ?>
